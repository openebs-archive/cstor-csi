...
- refact\(cvc\): add pvc annotation during provisioning [\#103](https://github.com/openebs/cstor-csi/pull/103) ([kmova](https://github.com/kmova))
- fix\(VERSION\): remove version dependency during volume provisioning [\#97](https://github.com/openebs/cstor-csi/pull/97) ([mittachaitu](https://github.com/mittachaitu))
- fix\(VERSION\): delete VERSION file from repo [\#94](https://github.com/openebs/cstor-csi/pull/94) ([mittachaitu](https://github.com/mittachaitu))

## [v1.12.0-RC2](https://github.com/openebs/cstor-csi/tree/v1.12.0-RC2) (2020-07-12)

**Merged pull requests:**

- refact\(cvc\): add pvc annotation during provisioning [\#103](https://github.com/openebs/cstor-csi/pull/103) ([kmova](https://github.com/kmova))

## [v1.12.0-RC1](https://github.com/openebs/cstor-csi/tree/v1.12.0-RC1) (2020-06-29)
...
- fix\(CStorVolumeAttachment\): Remove finalizer on unsuccesful mounts and on driver restarts \(\#82\) [\#85](https://github.com/openebs/cstor-csi/pull/85) ([payes](https://github.com/payes))
- refact\(operator\): add version and components labels in deployments [\#84](https://github.com/openebs/cstor-csi/pull/84) ([prateekpandey14](https://github.com/prateekpandey14))
- refact\(cvc\): update provision capacity field at provisioning [\#80](https://github.com/openebs/cstor-csi/pull/80) ([prateekpandey14](https://github.com/prateekpandey14))
- fix\(topology\): add customized topology key for node name [\#79](https://github.com/openebs/cstor-csi/pull/79) ([prateekpandey14](https://github.com/prateekpandey14))
- refact\(build\): make the docker images configurable [\#81](https://github.com/openebs/cstor-csi/pull/81) ([prateekpandey14](https://github.com/prateekpandey14))
- docs\(project\): add project contributor specific files and github templates [\#78](https://github.com/openebs/cstor-csi/pull/78) ([prateekpandey14](https://github.com/prateekpandey14))
- refact\(driver\): use openebs V1 api and remove unused codes  [\#75](https://github.com/openebs/cstor-csi/pull/75) ([prateekpandey14](https://github.com/prateekpandey14))

## [v1.10.0-RC2](https://github.com/openebs/cstor-csi/tree/v1.10.0-RC2) (2020-05-13)
...
## [v1.10.0-RC1](https://github.com/openebs/cstor-csi/tree/v1.10.0-RC1) (2020-05-07)
...
## [1.9.0](https://github.com/openebs/cstor-csi/tree/1.9.0) (2020-04-15)
...
## [1.9.0-RC2](https://github.com/openebs/cstor-csi/tree/1.9.0) (2020-04-14)
