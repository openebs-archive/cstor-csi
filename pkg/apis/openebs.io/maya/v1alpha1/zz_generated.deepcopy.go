...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *JivaVolumeClaim) DeepCopyInto(out *JivaVolumeClaim) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.Spec.DeepCopyInto(&out.Spec)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new JivaVolumeClaim.
func (in *JivaVolumeClaim) DeepCopy() *JivaVolumeClaim {
	if in == nil {
		return nil
	}
	out := new(JivaVolumeClaim)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *JivaVolumeClaim) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *JivaVolumeClaimList) DeepCopyInto(out *JivaVolumeClaimList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	out.ListMeta = in.ListMeta
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]JivaVolumeClaim, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new JivaVolumeClaimList.
func (in *JivaVolumeClaimList) DeepCopy() *JivaVolumeClaimList {
	if in == nil {
		return nil
	}
	out := new(JivaVolumeClaimList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *JivaVolumeClaimList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *JivaVolumeClaimSpec) DeepCopyInto(out *JivaVolumeClaimSpec) {
	*out = *in
	if in.JivaVolumeRef != nil {
		in, out := &in.JivaVolumeRef, &out.JivaVolumeRef
		*out = new(v1.ObjectReference)
		**out = **in
	}
	return
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new JivaVolumeClaimSpec.
func (in *JivaVolumeClaimSpec) DeepCopy() *JivaVolumeClaimSpec {
	if in == nil {
		return nil
	}
	out := new(JivaVolumeClaimSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *JivaVolumeClaimStatus) DeepCopyInto(out *JivaVolumeClaimStatus) {
	*out = *in
	if in.ReplicaStatuses != nil {
		in, out := &in.ReplicaStatuses, &out.ReplicaStatuses
		*out = make([]RepStatus, len(*in))
		copy(*out, *in)
	}
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new JivaVolumeClaimStatus.
func (in *JivaVolumeClaimStatus) DeepCopy() *JivaVolumeClaimStatus {
	if in == nil {
		return nil
	}
	out := new(JivaVolumeClaimStatus)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RepStatus) DeepCopyInto(out *RepStatus) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RepStatus.
func (in *RepStatus) DeepCopy() *RepStatus {
	if in == nil {
		return nil
	}
	out := new(RepStatus)
