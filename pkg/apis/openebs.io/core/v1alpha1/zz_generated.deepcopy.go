...
func (in *CSIISCSIInfo) DeepCopyInto(out *CSIISCSIInfo) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CSIISCSIInfo.
func (in *CSIISCSIInfo) DeepCopy() *CSIISCSIInfo {
	if in == nil {
		return nil
	}
	out := new(CSIISCSIInfo)
	in.DeepCopyInto(out)
	return out
}
