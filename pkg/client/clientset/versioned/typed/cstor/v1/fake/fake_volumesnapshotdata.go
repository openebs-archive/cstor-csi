...
var volumesnapshotdatasResource = schema.GroupVersionResource{Group: "cstor.openebs.io", Version: "v1", Resource: "volumesnapshotdatas"}

var volumesnapshotdatasKind = schema.GroupVersionKind{Group: "cstor.openebs.io", Version: "v1", Kind: "VolumeSnapshotData"}
...
func (c *FakeVolumeSnapshotDatas) Get(name string, options v1.GetOptions) (result *cstorv1.VolumeSnapshotData, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(volumesnapshotdatasResource, name), &cstorv1.VolumeSnapshotData{})
	if obj == nil {
		return nil, err
	}
	return obj.(*cstorv1.VolumeSnapshotData), err
}

// List takes label and field selectors, and returns the list of VolumeSnapshotDatas that match those selectors.
func (c *FakeVolumeSnapshotDatas) List(opts v1.ListOptions) (result *cstorv1.VolumeSnapshotDataList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(volumesnapshotdatasResource, volumesnapshotdatasKind, opts), &cstorv1.VolumeSnapshotDataList{})
	if obj == nil {
		return nil, err
	}
	...
	list := &cstorv1.VolumeSnapshotDataList{ListMeta: obj.(*cstorv1.VolumeSnapshotDataList).ListMeta}
	for _, item := range obj.(*cstorv1.VolumeSnapshotDataList).Items {
...
func (c *FakeVolumeSnapshotDatas) Create(volumeSnapshotData *cstorv1.VolumeSnapshotData) (result *cstorv1.VolumeSnapshotData, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(volumesnapshotdatasResource, volumeSnapshotData), &cstorv1.VolumeSnapshotData{})
	if obj == nil {
		return nil, err
	}
	return obj.(*cstorv1.VolumeSnapshotData), err
...
func (c *FakeVolumeSnapshotDatas) Update(volumeSnapshotData *cstorv1.VolumeSnapshotData) (result *cstorv1.VolumeSnapshotData, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(volumesnapshotdatasResource, volumeSnapshotData), &cstorv1.VolumeSnapshotData{})
	if obj == nil {
		return nil, err
	}
	return obj.(*cstorv1.VolumeSnapshotData), err
...
func (c *FakeVolumeSnapshotDatas) UpdateStatus(volumeSnapshotData *cstorv1.VolumeSnapshotData) (*cstorv1.VolumeSnapshotData, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(volumesnapshotdatasResource, "status", volumeSnapshotData), &cstorv1.VolumeSnapshotData{})
	if obj == nil {
		return nil, err
	}
	return obj.(*cstorv1.VolumeSnapshotData), err
...
func (c *FakeVolumeSnapshotDatas) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(volumesnapshotdatasResource, name), &cstorv1.VolumeSnapshotData{})
	return err
}
...
func (c *FakeVolumeSnapshotDatas) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &cstorv1.VolumeSnapshotDataList{})
	return err
}
...
func (c *FakeVolumeSnapshotDatas) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *cstorv1.VolumeSnapshotData, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(volumesnapshotdatasResource, name, pt, data, subresources...), &cstorv1.VolumeSnapshotData{})
	if obj == nil {
		return nil, err
	}
	return obj.(*cstorv1.VolumeSnapshotData), err
