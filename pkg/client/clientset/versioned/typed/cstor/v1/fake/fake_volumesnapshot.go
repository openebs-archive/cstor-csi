...
var volumesnapshotsResource = schema.GroupVersionResource{Group: "cstor.openebs.io", Version: "v1", Resource: "volumesnapshots"}

var volumesnapshotsKind = schema.GroupVersionKind{Group: "cstor.openebs.io", Version: "v1", Kind: "VolumeSnapshot"}
...
func (c *FakeVolumeSnapshots) Get(name string, options v1.GetOptions) (result *cstorv1.VolumeSnapshot, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(volumesnapshotsResource, c.ns, name), &cstorv1.VolumeSnapshot{})

	if obj == nil {
		return nil, err
	}
	return obj.(*cstorv1.VolumeSnapshot), err
}
...
func (c *FakeVolumeSnapshots) List(opts v1.ListOptions) (result *cstorv1.VolumeSnapshotList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(volumesnapshotsResource, volumesnapshotsKind, c.ns, opts), &cstorv1.VolumeSnapshotList{})
	...
	list := &cstorv1.VolumeSnapshotList{ListMeta: obj.(*cstorv1.VolumeSnapshotList).ListMeta}
	for _, item := range obj.(*cstorv1.VolumeSnapshotList).Items {
...
func (c *FakeVolumeSnapshots) Create(volumeSnapshot *cstorv1.VolumeSnapshot) (result *cstorv1.VolumeSnapshot, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(volumesnapshotsResource, c.ns, volumeSnapshot), &cstorv1.VolumeSnapshot{})
...
func (c *FakeVolumeSnapshots) Update(volumeSnapshot *cstorv1.VolumeSnapshot) (result *cstorv1.VolumeSnapshot, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(volumesnapshotsResource, c.ns, volumeSnapshot), &cstorv1.VolumeSnapshot{})
...
func (c *FakeVolumeSnapshots) UpdateStatus(volumeSnapshot *cstorv1.VolumeSnapshot) (*cstorv1.VolumeSnapshot, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(volumesnapshotsResource, "status", c.ns, volumeSnapshot), &cstorv1.VolumeSnapshot{})
...
func (c *FakeVolumeSnapshots) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(volumesnapshotsResource, c.ns, name), &cstorv1.VolumeSnapshot{})
...
func (c *FakeVolumeSnapshots) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &cstorv1.VolumeSnapshotList{})
	return err
}
...
func (c *FakeVolumeSnapshots) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *cstorv1.VolumeSnapshot, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(volumesnapshotsResource, c.ns, name, pt, data, subresources...), &cstorv1.VolumeSnapshot{})
