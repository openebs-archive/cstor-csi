	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.CstorV1().VolumeSnapshotDatas().List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CstorV1().VolumeSnapshotDatas().Watch(options)
			},
		},
		&cstorv1.VolumeSnapshotData{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *volumeSnapshotDataInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&cstorv1.VolumeSnapshotData{}, f.defaultInformer)
}
