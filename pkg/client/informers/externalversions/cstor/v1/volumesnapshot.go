	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.CstorV1().VolumeSnapshots(namespace).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CstorV1().VolumeSnapshots(namespace).Watch(options)
			},
		},
		&cstorv1.VolumeSnapshot{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *volumeSnapshotInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&cstorv1.VolumeSnapshot{}, f.defaultInformer)
}
