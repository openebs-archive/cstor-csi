...
) (*apismaya.CStorVolumeList, error)
...
func (k *Kubeclient) Create(vol *apismaya.CStorVolume) (*apismaya.CStorVolume, error) {
	if vol == nil {
		return nil,
