...
func (b *ListBuilder) WithAPIList(list *apismaya.CStorVolumeList) *ListBuilder {
	if list == nil {
		return b
	}
...
func NewForAPIObject(obj *apismaya.CStorVolume) *CStorVolume {
	return &CStorVolume{
		object: obj,
	}
}
